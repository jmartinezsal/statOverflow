...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert("Answers", [
      ...
      {
        answer: "Ive had no problems on PC.",
        questionId: 12,
        userId: 8,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      {
        answer: "There are some stutters but it's not the end of the world",
        questionId: 12,
        userId: 15,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      {
        answer: "They will drop 5x the runes they usually would.",
        questionId: 15,
        userId: 2,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      {
        answer: "Another katana like moonveil or meteoric ore blade",
        questionId: 16,
        userId: 2,
        createdAt: new Date(),
        updatedAt: new Date(),
